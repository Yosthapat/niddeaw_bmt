export default {
  ...
  home: {
    memberMarqueeLabel: 'Club members',
  ...
  profile: {
    ...
    estimatedWait: 'Approx. wait',
    myMatches: 'My Matches',
    seasonLabel: 'Season {n}',
    noSeasons: 'No seasons yet (no sessions played)',
  ...
  login: {
    ...
    stillWorking: 'Still working — hang tight',
    stillWorkingHint:
  ...
  matchmaking: {
    ...
    confirmGoesToQueueHint: 'Confirming sends it to "Queued Next" above — hit "Start Match" there once a court is actually free.',
    editPair: 'Edit Pair',
    confirm: 'Confirm',
    team: 'Team',
    ...
    saveEdit: 'Save Pair',
    editFailed: 'Failed to save the edited pair',
  ...
  billing: {
    ...
    qrFailed: 'Failed to load payment info — set up a payment method under Admin > Settings first',
  ...
  revenue: {
    ...
    fromBilling: 'From court fees',
    fromOtherIncome: 'From sponsors/investment',
    otherIncomeTitle: 'Other Income (sponsor / investment)',
  },
  settings: {
    title: 'Club Settings',
    ...
    paymentMethodPromptpay: 'PromptPay (amount auto-filled)',
    paymentMethodBankAccount: 'Bank Account Number',
    paymentMethodBankAccountQr: 'Generate QR from Bank Account',
    paymentMethodUploadedQr: 'Upload QR',
    bankName: 'Bank',
    bankAccountNumber: 'Account Number',
    bankAccountName: 'Account Name',
    uploadQr: 'Upload QR Image',
    replaceQr: 'Replace QR',
    qrUploadFailed: 'Failed to upload QR',
  ...
  expenses: {
    ...
    markingPaid: 'Saving...',
    paidStamp: 'Paid',
    markPaidFailed: 'Failed to mark expense paid',
  },
  income: {
    sourceLabels: {
      sponsor: 'Sponsor',
    ...
    date: 'Date',
    source: 'Type',
    sourceName: 'Name (e.g. sponsor / investor name)',
    sourceNameRequired: 'Please enter a name',
    amount: 'Amount',
    note: 'Note (optional)',
    slip: 'Slip photo',
    addSlip: 'Add slip',
    ...
    saving: 'Saving...',
    amountRequired: 'Please enter an amount greater than 0',
    createFailed: 'Failed to save income',
    empty: 'No other income yet',
    loadFailed: 'Failed to load income data',
