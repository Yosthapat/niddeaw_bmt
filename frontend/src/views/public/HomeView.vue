...
const tiers: { tier: EloTier; label: string; color: string; gradient?: string }[] = [
  ...
  { tier: 'wine', label: 'Wine', color: 'var(--color-tier-wine)' },
...
<template>
  <!-- Top padding is much smaller than the bottom: the match-tally card is
       the first thing in here, and a symmetric py-12/py-20 left it stranded
       48px (80px on desktop) below the header with nothing in between.
       The bottom keeps the original roomier padding, above the footer. -->
